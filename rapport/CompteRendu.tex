...
\begin{tabular}{|M{4cm}|M{3cm}|M{3cm}|M{3cm}|M{3cm}|}
   ...
   \hline
    \, &Cas ne comportant des erreurs & Cas ne comportant pas d'erreurs & Cas comportant des erreurs & Cas ne comportant pas d'erreurs \tabularnewline
   \hline
    Nombre d'erreurs d\'{e}tect\'{e}es / nombre de cas & 101 / 202 & 53 / 102 & 279 / 500 & 273 / 500 \tabularnewline
   \hline
     Pourcentage d'erreurs d\'{e}tect\'{e}es & 50 \% & 26 \% & 56\% & 56\% \tabularnewline
   \hline
\end{tabular}
\end{center}
...
\end{itemize}
 Le choix d'une telle impl\'{e}mentation r\'{e}sulte d'une premi\`{e}re r\'{e}flexion sur les possibles fautes que l'on peut faire, et le rapport de taille entre la faute et le mot en question. Puis cette r\'{e}flexion a \'{e}t\'{e} test\'{e}e de mani\`{e}re empirique sur 500 cas d'une base test, ou chaque cas rejet\'{e} ou accepté ont \'{e}t\'{e} analys\'{e} (seulement quelques fautes de conjugaison sont filtr\'{e}s \`{a} tort).
...
\begin{tabular}{|M{6cm}|M{5cm}|M{6cm}|}
   \hline
    \, &Nombre d'erreurs d\'{e}tect\'{e}es / nombre de cas trait\'{e}s & Pourcentage de phrases rejet\'{e}es \tabularnewline
   \hline
